...
#   B -> A (даже если он проходит через третьи вершины, т.к. в  изначальной задаче мы можем двигаться по обоим
#   типам дорог только в направлении от меньшего города к большему), т.е. мы можем попасть из A в B по двум типам дорог,
#   и, следовательно, карта не является оптимальной.
#   Кроме того,, развернув "стрелочки" для одного из типов дорог, мы закроем и случаи, когда в вершину
